<template>
  <InnerHeader title="Personal Care" subtitle="Our Services" />
                    ...
                    <div class="col-lg-3 widget-area sidebar-left ttm-col-bgcolor-yes ttm-bg ttm-left-span ttm-bgcolor-grey">
                        ...
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu box-shadow">
                                <li class="active"><a href="/personal-care">Personal Care</a></li>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="ttm-service-description">
                                        ...
                                        <div class="mb-35">
                                            <p>A Certified Nurse’s Aide (CNA) is a healthcare professional and a valued member of the healthcare team who plays a pivotal role in caring for patients by providing basic quality-of-life needs.</p>
                                            <p>Certified Nursing Assistants (CNAs) helps patients with hygiene, such as using the bathroom, bathing, brushing teeth and dressing. Assisting patients with meals by feeding them. Monitoring general health and vital signs and reporting to RN</p>
                                          
                                        </div>
                                        <h4>Our Certified Nursing Assistants (CNAs) assists with patient’s activities of daily living which includes:</h4>
                                        <div class="sep_holder_box width-100 mb-20">
                                            <span class="sep_holder"><span class="sep_line"></span></span>
                                            <span class="sep_holder"><span class="sep_line"></span></span>
                                        </div>
                                        ...
                                        <div class="row mt-15 mb-15">
                                            <div class="col-sm-6">
                                                <ul class="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor ttm-textcolor-darkgrey">
                                                    <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Assisting with light housekeeping, errands meal preparation.</span></li>
                                                    <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Ambulation, Range of motion activities and transfers.</span></li>
